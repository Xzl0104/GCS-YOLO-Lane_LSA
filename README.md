...
Monitoring snapshot at `2026-06-14` after official-val epoch 101: the run is alive with ordinary validation through epoch 102/180; official-val sweeps are recorded through epoch 101. GPU memory is about 18.6 GiB of 24.6 GiB, and utilization samples include `35%, 75%, 15%, 94%, 100%, 18%, 62%, 82%, 17%, 39%`, so the current `batch=32` server run is not obviously underusing the RTX 4090 and should not be interrupted. Official-best remains epoch 83 with `official_acc=0.956905`, above the current-code K32 audit `0.953756`, countboundary `0.954137`, and old FT6 `0.954782` references, but still below the legacy `0.959224` target. Epoch 97 is now the best ordinary-val row so far (`val/f1=0.959724`) and the second official Top-K candidate (`official_acc=0.956630`), but official-val remains the selection signal. Retained official Top-K is `83, 97, 101, 95, 96`; K56 is not promoted and no test result is claimed. Epoch 101 entered Top-K with `official_acc=0.956168`, but it did not beat epoch 83 and has higher FP/FN. Treat this as active baseline monitoring only; continue the healthy `batch=32` run and do not launch Count/Quality calibration until plateau is clearer or the run completes.
