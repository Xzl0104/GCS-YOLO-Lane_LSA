...
# Env30 follow-up v8.
#
# Isolate the low-FP part of v6 by adding only the selective far-extra guard
# to the env30 recipe. Do not add short-survival or GT5 point-valid rescue.
#
# Required:
#   PRETRAINED=/path/to/env30/weights/official_best.pt bash scripts/run_query_env30_far_extra_only_alpha05_v8.sh

RUN_NAME="${RUN_NAME:-query_env30_far_extra005_d80_alpha05_env30recipe_b32_amp_v8}"
