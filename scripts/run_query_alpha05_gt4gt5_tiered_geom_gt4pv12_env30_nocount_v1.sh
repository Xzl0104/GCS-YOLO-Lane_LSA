...
# Tiered matched GT4/GT5 weak-positive geometry rescue, GT4/GT5 ultra-short point-valid rescue, and env30 boundary mask.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_NAME="${RUN_NAME:-query_alpha05_gt4gt5_tiered_geom_gt4pv12_env30_nocount_v1}"
