...
# Env30 follow-up v7.
#
# Compared with v6, this keeps the alpha05/env30 boundary-pseudo/far-extra
# recipe unchanged and adds only GT5-targeted weak-lane protection:
#   - matched GT5 weak-visible geometry boost extends from visible<=10 to <=20
#   - matched GT5 visible<=10 point-valid positives get a small BCE multiplier
#
# Required:
#   PRETRAINED=/path/to/env30/weights/official_best.pt bash scripts/run_query_env30_short_survival_far_extra_gt5weakgeom_pv_v7.sh

RUN_NAME="${RUN_NAME:-query_env30_short_survival_far_extra_gt5weakgeom_pv_v7}"
