...
# Override variables from the shell when needed, e.g. BATCH=16 DEVICE=1 bash scripts/run_query_alpha05_gt5short_geom_w2_bneg005_nocount_v1.sh

RUN_NAME="${RUN_NAME:-query_alpha05_gt5short_geom_w2_bneg005_nocount_v1}"
...
run_train() {
  ...
  python tools/train_gcs.py \
    ...
    --gcs-boundary-pseudo-neg 0.05 \
    --gcs-boundary-pseudo-visible-thr 10 \
    --gcs-boundary-pseudo-dist-thr 60 \
    --gcs-boundary-pseudo-valid-thr 0.5 \
    --gcs-boundary-pseudo-min-valid 3 \
