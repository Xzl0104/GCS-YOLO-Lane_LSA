...
# Env30 follow-up v9.
#
# Keep the v8 far-extra guard on GT3/GT4, but remove far-extra pressure from
# GT5-or-denser samples after v8 showed reporting-only TEST GT5 undercount
# regression. Selection still uses canonical official-val only.
#
# Required:
#   PRETRAINED=/path/to/env30/weights/official_best.pt bash scripts/run_query_env30_far_extra_gt5off_alpha05_v9.sh

RUN_NAME="${RUN_NAME:-query_env30_far_extra005_d80_gt5off_alpha05_env30recipe_b32_amp_v9}"
