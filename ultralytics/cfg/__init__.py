...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_exist_quality_length_min_points",
        "gcs_exist_quality_length_full_points",
        "gcs_point_valid_pos_weight_max",
        "gcs_point_valid_length_weight_base_points",
        "gcs_point_valid_length_weight_max",
...
CFG_BOOL_KEYS = frozenset(
    {  # boolean-only arguments
        ...
        "gcs_exist_quality_length_adaptive",
        "gcs_point_valid_length_weight",
    }
)
