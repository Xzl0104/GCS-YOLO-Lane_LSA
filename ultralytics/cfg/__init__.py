...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_point",
        "gcs_point_valid",
        "gcs_point_valid_unmatched_ignore_px",
        "gcs_point_valid_unmatched_ignore_anchor_px",
        "gcs_smooth",
        "gcs_curve",
        "gcs_line_iou",
        "gcs_line_iou_width_px",
        "gcs_line_iou_temperature_px",
        "gcs_mask",
        "gcs_edge",
        "gcs_count",
        "gcs_count_under5",
        ...
        "gcs_gt4_selective_exist_target_ape_max",
        ...
        "gcs_culane_val_conf",
        "gcs_culane_val_point_valid_thr",
        "gcs_culane_val_nms_dist_px",
...
CFG_FRACTION_KEYS = frozenset(
    {  # fractional float arguments with 0.0<=values<=1.0
        ...
        "gcs_gt4_selective_exist_target_floor",
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "save_period",
        "gcs_eval_max_det",
        "gcs_culane_val_interval",
        "gcs_culane_val_max_det",
        "gcs_culane_val_max_images",
        "gcs_culane_val_warmup",
        ...
        "gcs_point_valid_unmatched_ignore_min_overlap",
        ...
        "gcs_gt4_selective_exist_target_visible_thr",
