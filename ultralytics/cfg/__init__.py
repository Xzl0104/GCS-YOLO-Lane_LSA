...
TASKS = frozenset({"detect", "segment", "classify", "pose", "obb", "gcs_lane"})
TASK2DATA = {
    "detect": "coco8.yaml",
...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_curve",
        "gcs_line_iou",
        "gcs_line_iou_half_width_px",
        "gcs_line_iou_valid_preserve",
        "gcs_line_iou_valid_max_ape_px",
        "gcs_line_iou_valid_gt4_weight",
        "gcs_line_iou_valid_gt5_weight",
        "gcs_dense_instance",
        "gcs_dense_centerline_weight",
        "gcs_dense_endpoint_weight",
        "gcs_dense_embed_pull_weight",
        "gcs_dense_embed_push_weight",
        "gcs_dense_embed_margin",
        "gcs_dense_sigma_px",
        "gcs_dense_pos_weight_max",
        "gcs_dense_endpoint_pos_weight_max",
        "gcs_dense_endpoint_peak_weight",
        "gcs_dense_endpoint_peak_radius_px",
        "gcs_dense_endpoint_offset_weight",
        "gcs_dense_endpoint_offset_radius_px",
        "gcs_dense_endpoint_balance_mode",
        "gcs_dense_candidate",
        "gcs_dense_candidate_quality_weight",
        "gcs_dense_candidate_replace_weight",
        "gcs_dense_candidate_quality_pos_weight_max",
        "gcs_dense_candidate_replace_pos_weight_max",
        "gcs_residual_proposal",
        "gcs_residual_point_weight",
        "gcs_residual_row_weight",
        "gcs_residual_valid_weight",
        "gcs_residual_interval_weight",
        "gcs_residual_interval_valid_consistency",
        "gcs_residual_positive_span",
        "gcs_residual_identity_pull_weight",
        "gcs_residual_identity_push_weight",
        "gcs_residual_quality_weight",
        "gcs_residual_quality_rank_weight",
        "gcs_residual_quality_rank_margin",
        "gcs_residual_quality_soft_px",
        "gcs_residual_quality_rank_target_gap",
        "gcs_residual_quality_hard_weight",
        "gcs_residual_identity_margin",
        "gcs_residual_identity_assign_px",
        "gcs_residual_quality_pos_weight_max",
        "gcs_residual_replace_weight",
        "gcs_residual_replace_pos_weight_max",
        "gcs_residual_replace_hit_px",
        "gcs_residual_replace_soft_px",
        "gcs_residual_replace_official_delta_scale",
        "gcs_residual_replace_official_min_delta",
        "gcs_residual_replace_official_pixel_thr",
        "gcs_residual_replace_official_pt_thr",
        "gcs_residual_replace_official_fp_weight",
        "gcs_residual_replace_official_fn_weight",
        "gcs_residual_replace_rank_weight",
        "gcs_residual_replace_listwise_weight",
        "gcs_residual_replace_listwise_positive_weight",
        "gcs_residual_replace_rank_margin",
        "gcs_residual_replace_rank_target_gap",
        "gcs_residual_replace_valid_thr",
        "gcs_residual_replace_min_points",
        "gcs_residual_replace_max_det",
        "gcs_residual_exist_weight",
        "gcs_residual_unmatched_weight",
        "gcs_residual_base_miss_px",
        "gcs_mask",
        "gcs_edge",
        "gcs_count",
        "gcs_count_under5",
        ...
        "gcs_slot_gt_bottom_x_beta",
        "gcs_slot_gt_bottom_x_soft",
        "gcs_slot_gt_bottom_x_soft_tau",
        "gcs_slot_gt_bottom_x_soft_beta",
        "gcs_slot_start_index_l1",
        "gcs_slot_start_index_l1_beta",
        "gcs_slot_exist_w4",
        "gcs_slot_exist_w5",
        "gcs_order_margin_px",
        "gcs_bottom_order_margin_px",
        "gcs_point_y_weight",
        "gcs_pixel_smoothl1_beta",
        "gcs_spurious_neg",
        "gcs_query_survival_rank",
        "gcs_query_survival_rank_margin",
        "gcs_query_survival_rank_max_ape_px",
        "gcs_query_valid_survival",
        "gcs_query_valid_survival_hit_px",
        "gcs_query_valid_survival_min_hit_ratio",
        "gcs_query_valid_survival_boundary_weight",
        "gcs_query_valid_survival_dice_weight",
        ...
        "gcs_aux_dice",
        "gcs_curve_alpha",
        "gcs_curve_weight_max",
        "gcs_cost_point",
        "gcs_cost_curve",
        "gcs_cost_exist",
        "gcs_match_max_x_dist",
        "gcs_match_gate_px",
        "gcs_eval_conf",
        "gcs_eval_ape_thr",
        "gcs_eval_match_gate_px",
        "gcs_eval_max_x_dist",
        "gcs_eval_nms_dist_px",
        "gcs_official_score_fp_weight",
        "gcs_official_score_fn_weight",
        "gcs_official_count_safe_acc_min_exclusive",
        "gcs_official_count_safe_fp_max",
        "gcs_official_count_safe_fn_max",
        "gcs_official_count_safe_count_acc4_min",
        "gcs_official_count_safe_count_acc5_min",
        ...
        "gcs_lane_instance_set",
        "gcs_lane_instance_visibility_weight",
        "gcs_lane_instance_endpoint_weight",
        "gcs_lane_instance_order_weight",
        "gcs_lane_instance_contiguity_weight",
        "gcs_lane_instance_positive_span_weight",
        "gcs_lane_instance_empty_weight",
        "gcs_lane_instance_geometry_quality_weight",
        "gcs_lane_instance_survival_weight",
        "gcs_lane_instance_duplicate_weight",
        "gcs_lane_instance_novelty_weight",
        ...
        "gcs_lane_instance_identity_temperature",
        "gcs_lane_instance_set_margin",
    }
)
CFG_FRACTION_KEYS = frozenset(
    {  # fractional float arguments with 0.0<=values<=1.0
        ...
        "gcs_lane_instance_decode_duplicate_thr",
        "gcs_lane_instance_decode_empty_thr",
    }
)
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "gcs_official_warmup",
        "gcs_official_count_safe_gt4_to3_max",
        "gcs_official_count_safe_gt4_to5_max",
        "gcs_official_count_safe_gt5_to4_max",
        "gcs_num_slots",
        "gcs_min_lanes",
        "gcs_max_lanes",
        "gcs_count_classes",
        "gcs_slot_gt_bottom_x_detach_interval",
        "gcs_min_interval_points",
        "gcs_match_min_overlap",
        "gcs_line_iou_short_min_points",
        "gcs_line_iou_valid_visible_thr",
        "gcs_line_iou_valid_min_visible",
        "gcs_eval_min_overlap",
        "gcs_lane_count_min_group",
        "gcs_count_under5_min_lanes",
        "gcs_spurious_max_points",
        "gcs_query_survival_rank_min_lanes",
        "gcs_lane_instance_decode_min_survivors",
...
CFG_BOOL_KEYS = frozenset(
    {  # boolean-only arguments
        ...
        "gcs_official_half",
        "gcs_official_save_epoch_checkpoints",
        "gcs_official_count_safe_selection",
        "gcs_official_count_safe_allow_output6",
        ...
        "gcs_dense_freeze_base",
        "gcs_residual_freeze_base",
        "gcs_residual_visibility_only",
        "gcs_residual_identity_only",
        "gcs_residual_topology_only",
        "gcs_residual_replacement_only",
        "gcs_residual_visual_replacement_only",
        "gcs_residual_listwise_replacement_only",
        "gcs_query_survival_freeze_base",
        "gcs_query_valid_survival_only",
        "gcs_query_valid_local_only",
        "gcs_query_valid_interval_only",
        "gcs_query_count_freeze_base",
        "gcs_line_iou_geometry_only",
        "gcs_lane_instance_decode_allow_empty",
    }
)
