...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_short_side_geom",
        "gcs_short_side_geom_weight_gt4",
        "gcs_short_side_geom_weight_gt5",
        "gcs_count_ce",
        "gcs_interval",
        "gcs_order",
        "gcs_gt_bottom_order",
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "gcs_short_side_geom_min_gt_lanes",
        "gcs_short_side_geom_visible_max",
        "gcs_spurious_max_points",
        "gcs_spurious_min_overlap",
        "gcs_spurious_gt_protect_min_overlap",
        "gcs_spurious_gt_protect_min_gt_lanes",
