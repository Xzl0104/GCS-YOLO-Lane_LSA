...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_gt4_near20_geom_refine",
        "gcs_gt4_near20_lower_px",
        "gcs_gt4_near20_upper_px",
        "gcs_gt4_near20_geom_curve",
        "gcs_boundary_pseudo_neg",
        "gcs_boundary_pseudo_dist_thr",
        "gcs_boundary_pseudo_valid_thr",
        "gcs_boundary_pseudo_score_thr",
        "gcs_boundary_pseudo_envelope_margin_px",
        "gcs_boundary_pseudo_envelope_ratio_thr",
        "gcs_boundary_pseudo_valid_neg_weight",
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "gcs_gt4_near20_visible_thr",
        "gcs_gt4_near20_min_overlap",
        "gcs_boundary_pseudo_visible_thr",
        "gcs_boundary_pseudo_min_valid",
        "gcs_boundary_pseudo_gt_count",
        "gcs_boundary_pseudo_max_gt_count",
