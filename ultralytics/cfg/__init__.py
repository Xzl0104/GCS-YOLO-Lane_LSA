...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_far_extra_neg",
        "gcs_far_extra_valid_thr",
        "gcs_far_extra_score_thr",
        "gcs_far_extra_dist_thr",
        "gcs_far_extra_gt3_weight",
        "gcs_far_extra_gt4_weight",
        "gcs_far_extra_gt5_weight",
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "gcs_short_survival_visible_thr",
        "gcs_far_extra_min_gt_lanes",
        "gcs_far_extra_max_gt_lanes",
        "gcs_far_extra_min_valid",
        "gcs_far_extra_max_valid",
