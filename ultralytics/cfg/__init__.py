...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_short_segment_base_choice_weight",
        ...
        "gcs_short_segment_unified_choice_weight",
        "gcs_short_segment_unified_choice_temperature",
        "gcs_short_segment_unified_choice_base_neg_weight",
        "gcs_short_segment_official_pt_thresh",
        "gcs_short_segment_base_valid_thr",
        "gcs_short_segment_base_choice_neg_weight",
        "gcs_full_lane_proposal",
        "gcs_full_lane_quality_tau",
        "gcs_full_lane_unmatched_valid_weight",
        "gcs_full_lane_unmatched_weight",
        "gcs_full_lane_aux_match_gate_px",
        "gcs_full_lane_focus_hit_px",
        "gcs_full_lane_focus_base_valid_thr",
        "gcs_full_lane_focus_base_min_coverage",
        "gcs_full_lane_base_hit_weight",
        "gcs_full_lane_base_miss_weight",
        "gcs_full_lane_gt4_weight",
        "gcs_full_lane_gt5_weight",
        "gcs_full_lane_short_visible_weight",
        "gcs_dense_instance",
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "gcs_full_lane_short_visible_thr",
...
CFG_BOOL_KEYS = frozenset(
    {  # boolean-only arguments
        ...
        "gcs_short_segment_candidate_aware_assignment",
        "gcs_short_segment_base_preserve",
        "gcs_short_segment_matched_assignment",
        "gcs_short_segment_listwise_all_candidates",
        "gcs_short_segment_official_quality_target",
        "gcs_short_segment_base_choice_all_queries",
        "gcs_full_lane_decode",
        "gcs_full_lane_aux_assignment",
        "gcs_full_lane_unified_matching",
        "gcs_full_lane_hard_focus",
