...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "gcs_quality_rescue_quality_thr",
        "gcs_quality_rescue_dist_px",
        "gcs_last_lane_rescue_conf_thr",
        "gcs_last_lane_rescue_point_valid_thr",
        "gcs_last_lane_rescue_mean_valid_thr",
        "gcs_last_lane_rescue_quality_thr",
        "gcs_last_lane_rescue_dist_px",
        "gcs_edge_rescue_conf_thr",
        "gcs_edge_rescue_point_valid_thr",
        "gcs_edge_rescue_mean_valid_thr",
        "gcs_edge_rescue_quality_thr",
        "gcs_edge_count4_to5_prob_margin",
        "gcs_soft_count_prob_margin",
        "gcs_soft_count_quality_weight",
        "gcs_soft_count_prior_weight",
        "gcs_soft_count_duplicate_penalty",
        "gcs_soft_count_invalid_penalty",
        "gcs_exist_pos_weight",
        "gcs_exist_focal_gamma",
        "gcs_exist_focal_alpha",
        "gcs_hard_negative_quality_thr",
        "gcs_hard_negative_exist_weight",
        "gcs_duplicate_negative_exist_weight",
        "gcs_duplicate_dist_thr_px",
        ...
        "gcs_point_valid_gt5_pos_weight",
        "gcs_point_valid_unmatched_weight",
        "gcs_point_valid_hard_negative_weight",
        "gcs_point_valid_duplicate_negative_weight",
        ...
        "gcs_official_best_count_acc4_weight",
        "gcs_official_best_count_acc5_weight",
        "gcs_official_best_rate_4_to_5_weight",
        "gcs_official_best_rate_3_to_5_weight",
        "gcs_official_best_rate_4_to_3_weight",
        "gcs_official_best_rate_3_to_4_weight",
        "gcs_official_best_rate_5_to_4_weight",
        "gcs_official_best_min_count_acc3",
        "gcs_official_best_min_count_acc4",
        "gcs_official_best_min_count_acc5",
        "gcs_official_best_min_gt5_output5_rate",
        "gcs_official_best_max_gt5_count_head_under_rate",
        "gcs_official_best_max_gt5_valid_points_fail_rate",
        "gcs_official_best_max_rate_3_to_4",
        "gcs_official_best_max_rate_4_to_3",
        "gcs_official_best_max_rate_4_to_5",
        "gcs_official_best_max_rate_3_to_5",
        "gcs_official_best_max_rate_5_to_4",
    }
)
CFG_FRACTION_KEYS = frozenset(
    {  # fractional float arguments with 0.0<=values<=1.0
        ...
        "gcs_exist_quality_lane_iou_alpha",
        "gcs_exist_quality_floor",
        "gcs_exist_pos_margin",
        "gcs_exist_neg_margin",
        "gcs_point_valid_neg_thr",
        ...
        "gcs_edge_rescue_quality_thr",
        "gcs_edge_count4_to5_prob_margin",
        "gcs_eval_min_gt_cover_ratio",
        "gcs_eval_min_pred_cover_ratio",
        "gcs_gt5_erasing",
        "gcs_gt5_blur",
        "gcs_gt5_noise",
        "gcs_gt5_shadow",
...
CFG_INT_KEYS = frozenset(
    {  # integer-only arguments
        ...
        "gcs_decode_fifth_min_points",
        "gcs_line_nms_min_overlap",
        "gcs_quality_rescue_min_points",
        "gcs_last_lane_rescue_min_policy_count",
        "gcs_last_lane_rescue_min_points",
        "gcs_edge_rescue_min_policy_count",
        "gcs_edge_rescue_min_points",
...
CFG_BOOL_KEYS = frozenset(
    {  # boolean-only arguments
        ...
        "profile",
        "gcs_official_best",
        "gcs_official_best_half",
        "gcs_use_count_head_decode",
        "gcs_enable_rescue_candidate_pool",
        "gcs_quality_rescue_5th",
        "gcs_last_lane_rescue",
