...
LOSS_GAIN_ARG_OVERRIDES = {
    ...
    "short_side_geom_loss": "gcs_short_side_geom",
    "spurious_neg_loss": (("gcs_spurious_neg", 0.0), ("gcs_spurious_neg_weight", 1.0)),
    "far_spur_loss": "gcs_far_spurious_neg",
    "shortside_rescue_exist_loss": "gcs_shortside_rescue_exist_gain",
    "shortside_rescue_point_loss": "gcs_shortside_rescue_point_gain",
    "shortside_rescue_valid_loss": "gcs_shortside_rescue_valid_gain",
    "shortside_ultra_point_loss": "gcs_shortside_ultra_point_gain",
    "shortside_ultra_valid_loss": "gcs_shortside_ultra_valid_gain",
    "farspur_if_loss": "gcs_farspur_weight",
    "rank_topk_loss": "gcs_rank_topk_weight",
}
LOSS_GAIN_ARGS = tuple(LOSS_GAIN_ARG_OVERRIDES.get(name) for name in LOSS_NAMES)
DEFAULT_LOSS_GAIN_OVERRIDES = {
    "exist_loss": 2.0,
    "point_loss": 15.0,
    ...
    "mask_loss": 0.2,
    "edge_loss": 0.2,
    # The score-floor item is already gain-weighted by its reliable/ultra knobs.
    "shortside_score_floor_loss": 1.0,
}
DEFAULT_LOSS_GAINS = tuple(float(DEFAULT_LOSS_GAIN_OVERRIDES.get(name, 0.0)) for name in LOSS_NAMES)
METRIC_NAMES = (
    "precision",
    "recall",
    "f1",
