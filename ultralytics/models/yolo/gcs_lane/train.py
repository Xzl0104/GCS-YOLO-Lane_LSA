...
GCS_MAINLINE_QUALITY_POINT_WEIGHT = 0.5
...
class GCSLaneTrainer(BaseTrainer):
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides: dict[str, Any] | None = None, _callbacks: dict | None = None):
        ...
        overrides.setdefault("gcs_survival_target_mode", "matched")
        overrides.setdefault("gcs_fifth_gate_hard_negative_weight", 2.0)
        ...
        overrides.setdefault("gcs_count_boundary_hard_margin", 0.2)
        overrides.setdefault("gcs_count_boundary_hard_margin_gain", 0.0)
