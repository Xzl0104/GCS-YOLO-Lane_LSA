...
The min-points row is validation-selected and not promoted because it carries GT4-to-5 false fifth-lane risk (`count_acc_4=0.863636`). The rejected K56 gates are `gcs_yolo_lane_s_q12_k56_cqcalib_ft12_seed1_b32w4`, `gcs_yolo_lane_s_q12_k56_cqcalib_lr1e4_ft8_seed1_b32w4`, `gcs_yolo_lane_s_q12_k56_curveaux_ft8_seed1_b32w4`, `gcs_yolo_lane_s_q12_k56_lowfp_joint_ft8_seed1_b32w4`, and `gcs_yolo_lane_s_q12_k56_countadj_lowmargin_ft8_seed1_b32w4`; do not rerun or continue those exact recipes as the next path.
