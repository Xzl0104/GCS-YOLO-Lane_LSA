...
GPU utilization sample at 2026-06-14 epoch112 audit: 0%, 2%, 0%, 22%, 2%, 0%; treat as point-in-time utilization showing the healthy batch=32 run is not obviously underusing server VRAM
status at 2026-06-14 epoch112 audit: training alive with ordinary-val row 113/180; root official_best_summary has official-val candidates through epoch 112
ordinary val latest row: epoch=113, val/f1=0.957291, precision=0.957660, recall=0.956923, val/decode/count_head_k=3.61708, val/decode/final_pred_lanes=3.57851, val/decode/k5_to_output4_rate=0.191781
ordinary val best row so far by val/f1: epoch=97, val/f1=0.959724, precision=0.957154, recall=0.962308
official_best so far: epoch 109, official_acc=0.957664, FP=0.051056, FN=0.035124
official_best count/GT5 diagnostics: count_acc_3/4/5=0.923767/0.833333/0.783784, gt5_output5_rate=0.783784, gt5_count_head_under_rate=0.094595, gt5_valid_points_fail_rate=0.121622, gt5_candidate_pool_shortfall_rate=0.000000, gt5_top5_suppressed_by_nms_rate=0.000000, decode/k5_to_output4_rate=0.148649, rescue_precision=0.761905, rate_3_to_4=0.076233, rate_4_to_5=0.090909, rate_5_to_4=0.216216, matched/unmatched_quality_mean=0.892759/0.789271
official_top_k retained epochs and ACC: 109=0.957664, 110=0.957280, 112=0.956981, 83=0.956905, 108=0.956831
latest official-val candidate: epoch=112, official_acc=0.956981, FP=0.046648, FN=0.035813, count_acc_3/4/5=0.928251/0.909091/0.716216, gt5_output5_rate=0.716216, gt5_count_head_under_rate=0.108108, gt5_valid_points_fail_rate=0.175676, gt5_candidate_pool_shortfall_rate=0.000000, gt5_top5_suppressed_by_nms_rate=0.000000, rescue_precision=0.854545
diagnostic top-k notes: epoch109 refreshes K56 official-best and exceeds the current-code K32 audit 0.953756 by +0.003908, countboundary 0.954137 by +0.003527, old FT6 0.954782 by +0.002882, and prior K56 epoch83 best 0.956905 by +0.000759. It remains below legacy 0.959224 by -0.001560 and below the 0.97 objective. The gain comes with higher FP and weaker GT4/GT5 count retention than epoch83, while candidate supply and GT5 NMS remain non-dominant. The next K56 candidate, if needed after clearer plateau or completion, should preserve epoch109 official ACC gain while reducing FP, GT4->5 over-count, and GT5 valid-points failure through training-side Count/Quality calibration from an official-val-selected K56 checkpoint.
errors: process is alive; results.csv has no numeric NaN/Inf values across 113 rows; 113 run JSON files have no parse error and no numeric NaN/Inf values; official-val sweeps exist through epoch112. A text-artifact scan of 225 run files found no `--split test`, `split: test`, `test_label.json`, or `test_set` hits. args.yaml records split=val, gcs_official_best_split=val, imgsz=[544, 960], gcs_imgsz=[544, 960], and K56 data/model. Note that the active summary is at run root `official_best_summary.json`; `weights/official_best_summary.json` is absent while `weights/official_best.pt` exists.
